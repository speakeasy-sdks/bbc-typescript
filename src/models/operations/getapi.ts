...
export namespace GetAPIResponse$ {
    export const inboundSchema: z.ZodType<GetAPIResponse, z.ZodTypeDef, unknown> = z
        .object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, GetAPIResponse> = z
        .object({
