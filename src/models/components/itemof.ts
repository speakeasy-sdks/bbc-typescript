...
/** @internal */
export namespace ItemOf$ {
    export const inboundSchema: z.ZodType<ItemOf, z.ZodTypeDef, unknown> = z
        .object({
            href: z.string(),
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, ItemOf> = z
        .object({
            href: z.string(),
            resultType: z.string(),
