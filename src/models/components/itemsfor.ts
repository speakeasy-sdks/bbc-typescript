...
/** @internal */
export namespace ItemsFor$ {
    export const inboundSchema: z.ZodType<ItemsFor, z.ZodTypeDef, unknown> = z
        .object({
            href: z.string(),
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, ItemsFor> = z
        .object({
            href: z.string(),
            resultType: z.string(),
