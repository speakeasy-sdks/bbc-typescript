...
/** @internal */
export namespace Ancestors$ {
    export const inboundSchema: z.ZodType<Ancestors, z.ZodTypeDef, unknown> = z
        .object({
            href: z.string(),
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, Ancestors> = z
        .object({
            href: z.string(),
            resultType: z.string(),
