...
import { EpisodeOf, EpisodeOf$ } from "./episodeof";
...
export namespace Episode$ {
    export const inboundSchema: z.ZodType<Episode, z.ZodTypeDef, unknown> = z
        .object({
        ...
        .transform((v) => {
            return {
                ...
                ...(v.episode_of === undefined ? null : { episodeOf: v.episode_of }),
                ...
                ...(v.has_guidance === undefined ? null : { hasGuidance: v.has_guidance }),
                ...
                ...(v.is_stacked === undefined ? null : { isStacked: v.is_stacked }),
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, Episode> = z
        .object({
        ...
        .transform((v) => {
            return {
                ...
                ...(v.isStacked === undefined ? null : { is_stacked: v.isStacked }),
